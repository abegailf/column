...
export const presets: Preset[] = [
  ...
  { id: 'portra_160', name: 'Portra 160', lutUrl: '/Presetpro - Portra 160.cube', cssFilter: 'none' },
  { id: 'fuji_film', name: 'Fuji Film', lutUrl: '/Presetpro - Fuji Film.cube', cssFilter: 'none' },
  { id: 'moody_blue', name: 'Moody Blue', lutUrl: '/Presetpro - Moody Blue.cube', cssFilter: 'none' },
